...
<<<<<<< HEAD
    methods: {
      onSubmit() {
          this.form.list='活动名称:'+this.form.name+'<br>'+'活动区域:'+this.form.region+'<br>'+'活动时间:'+this.form.date1+this.form.date2+'<br>'+'即使配送:'+this.form.delivery+'<br>'+'活动性质:'+this.form.type+'<br>'+'特殊资源:'+this.form.resource+'活动形式:'+this.form.desc;
