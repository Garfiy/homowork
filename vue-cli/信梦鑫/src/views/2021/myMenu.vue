...
<el-row>
    ...
    <el-col :span="3"> 
      ...
      <el-menu :router="true">
          ...
          <el-menu-item index="/homework/2021/0413">20210413</el-menu-item>
        </el-menu-item-group>
          </el-submenu>
          <!-- 第二个 一级标签 -->
          <el-submenu index="2">
              ...
              <el-submenu index="03-25">
                 ...
                 <el-menu-item-group>
                   ...
                   <el-menu-item index="/study/2021/0325/01">路由重定向</el-menu-item>
                 </el-menu-item-group>
              ...
              <el-submenu index="03-24">
               <!-- 起名字 -->
                ...
                <el-menu-item index="/study/2021/0324/cc">动态路由params传参</el-menu-item>
                <el-menu-item index="/study/2021/0324?name=123">动态路由query传参</el-menu-item>
