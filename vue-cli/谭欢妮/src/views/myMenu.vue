      ...
      <el-menu :router="true">
        ...
        <el-submenu index="2">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/study/2021/0324/德云社">params0324</el-menu-item>
            <el-menu-item index="/study/2021/0324?name=德云社">query0324</el-menu-item>
            <el-menu-item @click="$router.push({path:'/study/2021/0324',query:{name:'编程式导航'}})">编程式导航</el-menu-item>
