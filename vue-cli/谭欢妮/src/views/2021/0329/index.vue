 <template>
  <el-table :data="tableData" style="width: 100%" max-height="500">
    <el-table-column fixed prop="date1" label="活动日期" width="150">
    </el-table-column>
    <el-table-column fixed prop="date2" label="活动时间" width="150">
    </el-table-column>
    ...
    <el-table-column prop="delivery" label="即时配送" width="120">
    </el-table-column>
