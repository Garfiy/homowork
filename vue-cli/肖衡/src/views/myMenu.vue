      ...
      <el-menu :router="true">
        ...
        <el-submenu index="2">
          ...
          <el-submenu index="03-25">
            ...
            <el-menu-item-group>
              <el-menu-item index="/study/2021/0325/01">重定向路由</el-menu-item>
              <el-menu-item index="/study/2021/0325/02">重定向判断路由</el-menu-item>
              <el-menu-item index="/liebiao">别名</el-menu-item>
              <el-menu-item index="/study/2021/0325/03/66">路由parps传参</el-menu-item>
              <el-menu-item index="/study/2021/0325/03?id=66">路由query传参</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <!-- 二级菜单 -->
